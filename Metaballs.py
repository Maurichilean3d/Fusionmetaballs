...
def _create_mesh(component, vertices, triangles):
    ...
    mesh_manager = getattr(component, 'meshManager', None)
    if not mesh_manager:
        raise RuntimeError('No se encontró UInt32Array/Int32Array ni meshManager en este entorno.')

    mesh = mesh_manager.createMesh()
